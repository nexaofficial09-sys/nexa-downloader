...
export default function Home() {
  ...
  if (isMaintenance && typeof window !== "undefined" && window.location.hostname !== "localhost") {
    return (
      <main className="min-h-screen bg-slate-950 text-slate-300 font-sans flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="max-w-md w-full bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 text-center relative z-10 shadow-2xl">
          ...
          <p className="text-slate-400 leading-relaxed mb-6">
            NEXA Downloader sedang dalam peningkatan sistem untuk melayani Anda lebih baik. Kami akan segera kembali!
          </p>
